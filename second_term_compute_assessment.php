...
<!DOCTYPE HTML>
<html>
<head><title>Compute Second Term Assessment Report</title>
...
<li class="breadcrumb-item active">Compute Second Term Assessment Report</li>  
</ol><br>
<h5 style=" border-bottom:1px solid #eee;line-height:180%" class="text-primary"><i class="fa fa-edit"></i>  Second Term  Assessments Reports </h5><br>
...
if($conn->connect_error){
	...
	if(!isset($_SESSION['success'])){
		echo"
		<form method='POST' action='do_second_term_assessment.php'>
...
<button type='submit' class='btn btn-md aqua-gradient'>SUBMIT</button>
	...
	<h5 style='border-bottom:1px solid #eee;line-height:180%'><i class='fa fa-check'></i> SUCCESS</h5>
			...
			echo"<button type='button' class='btn btn-sm btn-primary'><a href='second_term_compute_assessment_report.php?s_id=$student_id &c_name=$class_name &f_tr=$second_term' style='color:white'><i class='fa fa-angle-double-left'></i> BACK</a></button>

			<button type='button' class='btn btn-sm btn-success'><a href='second_term_compute_cognitive_report.php?s_id=$student_id &c_name=$class_name &f_tr=$second_term' style='color:white'> NEXT <i class='fa fa-angle-double-right'></i></a></button>";
				}
