...
<!DOCTYPE HTML>
<html>
<head><title>Create Third Term Report Card</title>
...
<li class="breadcrumb-item">Create Report Card</li>  
</ol><br>
<h5 style="border-bottom:1px solid #eee;line-height:180%"><i class="fa fa-edit"></i> Create Third Term Report Card</h5><br>
<?php
...
if($conn->connect_error){
	...
	?>
		...
		<button type='button' class='btn btn-md blue-gradient'><?php echo"<a href='third_term_compute_assessment.php?s_id=$student_id&c_name=$class_name&f_tr=$third_term' style='color:white'><i class='fa fa-edit'></i> Compute Assessment Report</a></button>"; ?> 
		<button type='button' class='btn btn-md purple-gradient'><?php echo"<a href='third_term_cognitive_report.php?s_id=$student_id&c_name=$class_name&f_tr=$third_term' style='color:white'><i class='fa fa-table'></i> Compute Cogntive Report</a></button>"; ?> 
		
		<button type='button' class='btn btn-md aqua-gradient'><?php echo"<a href='third_term_observation_conduct_report.php?stud_id=$student_id&class_name=$class_name&f_tr=$third_term' style='color:white'><i class='fa fa-edit'></i> Compute Observation of Conduct Report</a></button>"; ?> 
