...
<h6 align="center"><span style='background:black;color:white;font-size:1.3em;'>STUDENT ID CARD</span></h6>
<?php
...
while($results=$query->fetch_array(MYSQLI_ASSOC)){
	...
	echo"
	<img style='margin-left:35px;' class='img-rounded' src='studentImages/".$results['student_img']."' alt='img' width='170px' height='170px'>
	
		<h6 style='color:blue;margin-left:10px' align='center'>ID NO: S-ID ".$results['student_id']."</h6>
	<h6 style='margin-left:10px'><strong>NAME:</strong> ".strtoupper("".$results['student_name']."")." </h6>
	<h6 style='margin-left:10px'><strong>ROLE:</strong> Student</h6>
			<h6 style='margin-left:10px'><strong>GENDER:</strong> ".$results['sex']."</h6>
			<h6 style='margin-left:10px'><strong>CLASS:</strong> ".$results['class_name']."</h6>
