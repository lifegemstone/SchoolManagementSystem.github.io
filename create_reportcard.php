...
<li class="active">Create Report Card</li>  
</ol>
<h4 class="page-header text-primary"><i class="fa fa-edit"></i> Create Report Card</h4>
    <?php	if($teacher_id == ""){
		    
		    echo "<span style='color:red'>No Class Has Been Assigned To Your Account Yet. Kindly Contact Your Admin!!!</span>";
		    exit();
		}
	?>
<form  class="form-vertical" id='class_form' action="student_reportcard.php" method="GET">
