...
<!DOCTYPE HTML>
<html>
<head><title>Attendance Present List</title>
...
<li class="active">ATTENDANCE PRESENT LIST</li> 
</ol>
...
<form  class="form-horizontal" action="do_present_list.php" id="custom_form"  method="GET">
