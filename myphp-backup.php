...
define("BACKUP_DIR", 'app_backup'); // Comment this line to use same script's directory ('.')
        ...
        try {
            ...
            */
            foreach($tables as $table) {
                ...
                $this->obfPrint("<i class='fa fa-check text-success'></i> OK");
            }
...
<li class="active"><i class="fa fa-database"></i> DATABASE BACKUP</li> 
</ol>';
$backupDatabase = new Backup_Database(SERVER_NAME, DB_USER, DB_PASSWORD, DB_NAME); 
//$_SESSION['backup_msg']=ucwords('your data has been successfully backed up');
