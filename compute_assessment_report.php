...
<!DOCTYPE HTML>
<html>
<head><title>Compute Assessment Report</title>
...
<li class="breadcrumb-item active">Compute Assessment Report</li>  
</ol>
<br>
<h5 style="border-bottom:1px solid #eee;line-height:180%"><i class="fa fa-edit"></i> Compute Report Assessments</h5><br>
...
if($conn->connect_error){
	...
	if(!isset($_SESSION['success'])){
		echo"
		<form method='POST' action='do_compute_assessment.php'>
...
<button type='submit' class='btn btn-md aqua-gradient'>SUBMIT</button>
	...
	<h4 class='page-header'><i class='fa fa-check'></i> SUCCESS</h4>
			...
			<button type='button' class='btn btn-sm btn-success'><a href='compute_cognitive_report.php?s_id=$student_id &c_name=$class_name &f_tr=$first_term' style='color:white'> NEXT <i class='fa fa-angle-double-right'></i></a></button>";
				}
