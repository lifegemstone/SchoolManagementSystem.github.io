...
if($conn->connect_error) die ("could not connect to the database");
		...
		$select="SELECT s.student_name as student_name,a.class_name as class_name,a.attendance_status,a.attendance_date  FROM students AS s INNER JOIN attendance as a  ON s.student_id=a.student_id WHERE a.class_name='$class_name' AND attendance_date BETWEEN '$start_date' AND '$end_date' AND attendance_status='Present' ORDER BY attendance_date";				
	$query=$conn->query($select);
	$filename="present_list.xls";
