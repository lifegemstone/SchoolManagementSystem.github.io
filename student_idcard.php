 ...
 <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
			   ...
			   <?PHP echo'<div class="mr-5" style="font-size:1.5em;"><p style="padding:17px"><a href="student_frontpage.php?s_id='.$student_id.'&usrcd='.$usrcd.'" class="link"><i class="fa  fa-credit-card"></i> FRONT OF ID CARD</a></p></div>';
...
<div class="col-sm-4 col-md-4 col-lg-4">
 <div class="card text-white bg-primary o-hidden h-100">
			...
			<?php   echo'<div class="mr-5" style="font-size:1.5em;"><p style="padding:17px"><a href="student_backpage.php?s_id='.$student_id.'&usrcd='.$usrcd.'" class="link"><i class="fa fa-credit-card"></i> BACK OF ID CARD</a></p></div>';?>
            </div>
			  </div>
			 </div>
