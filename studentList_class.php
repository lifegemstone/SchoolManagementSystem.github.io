	...
	<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th> S/N </th>
                                        <th>Student Name</th>
                                        <th>View Report Card Archives</th>								
                                    </tr>
                                </thead>
                                <tbody>';
						...
						echo '<tr>
                                  <td>'.$id.'</td>
								   <td>'.$results['student_name'].'</td>
									<td class="text-primary"><a href="view_reportCardArchives.php?stud_id='.$results['student_id'].' &class_name='.$class_name.'"><i class="fa fa-database"></i> View Report 	Card Archives</a></td>
