...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    ...
                                    <tr>
                                         ...
                                         <th>Email</th>
										 <th>Role</th>
										 <th><i class='fa fa-unlock'></i> Reset Password</th>
										 <th><i class='fa fa-trash'></i> Delete User</th>
						...
						$select1="SELECT * FROM users ORDER BY name";
                                  ...
                                  <td>'.$id.'</td>
								   <td>'.$results['name'].'</td>
									...
									if($results['name']=="admin"){
										echo"
												<i class='fa fa-bolt text-primary'> Super User</i>";
									}
									else{
											echo"<a href='delete_appUser.php?usr_id=".$results['user_id']."&usrcd=".$usrcd."'>Delete User</a>";
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"  style="color:green"><span class="fa fa-unlock" style="color:black" aria-hidden="true"></span> Reset User Account</h4>
				</div>
