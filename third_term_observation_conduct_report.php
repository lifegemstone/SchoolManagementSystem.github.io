...
<!DOCTYPE HTML>
<html>
<head><title>Compute Third Term Observation/conduct Report</title>
...
<li class="breadcrumb-item active">Compute Third term Observation/conduct Report</li>  
</ol><br>
<h5 style='border-bottom:1px solid #eee;line-height:180%'><i class="fa fa-edit"></i> Compute Third Term Observation/conduct Report</h5><br>
<?php
...
if(!isset($_SESSION['success'])){
	echo"
	<form method='POST' action='do_third_term_observation_conduct.php'>
...
<br><br>
<label for='class_teacher' class='control-label'>Class Teacher's Comment:</label>
...
<button type='submit' class='btn btn-md aqua-gradient'>SUBMIT</button>
	...
	<h5 style='border-bottom:1px solid #eee;line-height:180%'><i class='fa fa-check'></i> SUCCESS</h5>
			...
			echo"<button type='button' class='btn btn-sm btn-primary'><a href='third_term_cognitive_report.php?s_id=$student_id &c_name=$class_name &f_tr=$third_term' style='color:white'><i class='fa fa-angle-double-left'></i> BACK</a></button>

			<button type='button' class='btn btn-sm btn-success'><a href='view_thirdReportCard.php?stud_id=$student_id &class_name=$class_name&f_tr=$third_term' style='color:white'> FINISH/VIEW REPORT CARD <i class='fa fa-angle-double-right'></i></a></button>";
				}
