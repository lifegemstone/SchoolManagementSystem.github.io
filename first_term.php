...
<!DOCTYPE HTML>
<html>
<head><title>Create First Term Report Card</title>
...
<h5 style="border-bottom:1px solid #eee;line-height:180%"><i class="fa fa-edit"></i> Create First Term  Report Card</h5><br>
<?php
...
if($conn->connect_error){
	...
	?>
		...
		<?php echo"<button type='button' class='btn btn-md blue-gradient'><a href='compute_assessment_report.php?s_id=$student_id &c_name=$class_name &f_tr=$first_term' style='color:white'><i class='fa fa-edit'></i> Compute Assessment Report</a></button>"; ?> 
	<?php echo"	<button type='button' class='btn btn-md purple-gradient'><a href='compute_cognitive_report.php?s_id=$student_id &c_name=$class_name &f_tr=$first_term' style='color:white'><i class='fa fa-table'></i> Compute Cogntive Report</a></button>"; ?> 
		
		<?php echo"<button type='button' class='btn btn-md aqua-gradient'><a href='compute_observation_conduct_report.php?s_id=$student_id &c_name=$class_name &f_tr=$first_term' style='color:white'><i class='fa fa-edit'></i> Compute Observation of Conduct Report</a></button>"; ?> 
