...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($conn->connect_error){
		...
		for($i=0;$i<$count;$i++){
			...
			$remark=$remarks["$i"];
		$insert1="INSERT INTO first_term(id,subjects,other_CA,CA,exams,total_score,grade,remark,student_id,class_name,term_status)VALUES('','$subject','$otherCA','$stud_CA','$stud_exam','$total_score','$grade','$remark','$student_id','$class_name','0')";
	...
	$insert2="INSERT INTO totalscore(id,student_id,totalscore,class_name,term)VALUES('','$student_id','$sum','$class_name','$term')";
	...
	if($conn->affected_rows>1){
		...
		for($i=0;$i<$count_params;$i++){
			...
			$grade=$param_grade["$i"];
			print_r($grade);
		$insert4="INSERT INTO observation_conduct_grades(id,student_id,params,grade,class_name,term,teachers_comment)VALUES('','$student_id','$conduct_param','$grade','$class_name','$term','')";
