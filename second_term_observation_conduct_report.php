...
<!DOCTYPE HTML>
<html>
<head><title>Compute Second Term Observation/conduct Report</title>
...
<li class="breadcrumb-item active">Compute Second Term Observation/conduct Report</li>  
</ol><br>
<h5 style='border-bottom:1px solid #eee;line-height:180%'><i class="fa fa-edit"></i> Compute Second Term Observation/conduct Report</h5><br>
<?php
...
if($conn->connect_error){
	die('could not connect to the database');
		...
		<img src='studentImages/{$results['student_img']}'  class='img-fluid rounded z-depth-2' alt='image'><br><br>
		</div>
...
if(!isset($_SESSION['success'])){
	echo"
	<form method='POST' action='do_second_term_observation_conduct.php'>
...
<button type='submit' class='btn btn-md aqua-gradient'>SUBMIT</button>
	...
	<h5 style='border-bottom:1px solid #eee;line-height:180%'><i class='fa fa-check'></i> SUCCESS</h5>
			...
			<button type='button' class='btn btn-sm btn-success'><a href='view_secondReportCard.php?stud_id=$student_id &class_name=$class_name' style='color:white'> FINISH/VIEW REPORT CARD <i class='fa fa-angle-double-right'></i></a></button>";
				}
